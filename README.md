...
Operating Systems: Three Easy Pieces by Remzi H. Arpaci-Dusseau (Free online: http://pages.cs.wisc.edu/~remzi/OSTEP/)
...
Course:
Computer Systems (CS50 by Harvard University on edX) (https://www.edx.org/course/cs50s-introduction-to-computer-science)
Lecture Series:
MIT OpenCourseWare – Introduction to Computer Science (https://ocw.mit.edu/courses/6-0001-introduction-to-computer-science-and-programming-in-python-fall-2016/)
...
Course:
Digital Systems and Computer Architecture by University of London (Coursera) (https://www.coursera.org/specializations/computer-architecture)
Lecture Series:
Computer Architecture by Princeton University (YouTube) (https://www.youtube.com/playlist?list=PL59B235066B4A96A4)
...
Time Series Analysis and Forecasting (Udemy) (https://www.udemy.com/course/time-series-analysis/)
Tool:
...
Course:
Human-Computer Interaction by Stanford University (Coursera) (https://www.coursera.org/learn/human-computer-interaction)
Tool:
...
Resources:
Books:
Graph Theory by Reinhard Diestel (Free online: https://diestel-graph-theory.com/)
Introduction to Graph Theory by Douglas B. West (Available on Amazon)
Course:
Graph Theory and Social Networks by University of California (edX) (https://www.edx.org/course/graph-theory-social-networks)
Lecture Series:
Graph Algorithms by Abdul Bari (YouTube) (https://www.youtube.com/playlist?list=PLDN4rrl4YxDIOlW_F_s-0dYjV_a_89L8y)
6. Cloud Computing
...
Course:
AWS Cloud Practitioner Essentials (AWS Training) (https://aws.amazon.com/training/)
Tool:
...
Distributed Systems by MIT (OpenCourseWare) (https://ocw.mit.edu/courses/6-824-distributed-systems-spring-2020/)
Lecture Series:

Distributed Systems by University of Cambridge (https://www.cl.cam.ac.uk/teaching/2223/ConcDisSys/)
...
Linear Programming by Stanford University (Coursera) (https://www.coursera.org/learn/linear-programming)
Tool:

PuLP (https://pypi.org/project/PuLP/) and Gurobi (https://www.gurobi.com/) libraries in Python
9. Edge Computing
...
Course:
IoT and Edge Computing for Developers by IBM (Coursera) (https://www.coursera.org/professional-certificates/iot-edge-computing)
Tool:
...
Resources:
Books:
High-Performance Computing by Charles Severance (Free online: https://www.cse.msu.edu/~cse830/)
Using OpenMP by Barbara Chapman (Available on Amazon)
Course:
Parallel Programming with MPI and OpenMP (Coursera) (https://www.coursera.org/learn/parallel-programming-mpi)
Tool:
...
Course:
Software Testing Fundamentals (Udemy) (https://www.udemy.com/course/software-testing/)
Tool:
Selenium (https://www.selenium.dev/), JUnit (https://junit.org/junit5/), PyTest (https://docs.pytest.org/en/7.4.x/)
...
Resources:
Books:
Speech and Language Processing by Jurafsky & Martin (Free online drafts available: https://web.stanford.edu/~jurafsky/slp3/)
Deep Learning for NLP by Palash Goyal (Available on Amazon)
Natural Language Processing with Python by Steven Bird (Free online: https://www.nltk.org/book/)
Course:
NLP Specialization by DeepLearning.AI (Coursera) (https://www.coursera.org/specializations/natural-language-processing)
Tool:
NLTK (https://www.nltk.org/), SpaCy (https://spacy.io/), Hugging Face (https://huggingface.co/)
...
Research Papers:
Attention Is All You Need (https://arxiv.org/abs/1706.03762), BERT (https://arxiv.org/abs/1810.04805), GPT (Original research papers)
Course:
Transformers and LLMs (Hugging Face Course) (https://huggingface.co/learn/nlp-course/)
Tool:
Hugging Face, OpenAI API (https://openai.com/)
14. Cryptography
...
Course:
Applied Cryptography by Stanford (Coursera) (https://www.coursera.org/learn/crypto)
Tool:
OpenSSL (https://www.openssl.org/), PyCryptodome (https://pypi.org/project/pycryptodome/)
15. Network Security
...
Course:
Network Security by Georgia Tech (edX) (https://www.edx.org/micromasters/gtx-cybersecurity)
Tool:
Wireshark (https://www.wireshark.org/), Snort (https://www.snort.org/)
...
Course:
Operating Systems by MIT (OpenCourseWare) (https://ocw.mit.edu/courses/6-828-operating-system-engineering-fall-2012/)
Lecture Series:
Operating Systems by Neso Academy (YouTube) (https://www.youtube.com/playlist?list=PLBlnK6fEyqRiV1i0f7_iK87K69-x32XgI)
17. Soft Computing
...
Course:
Introduction to Soft Computing (NPTEL) (https://nptel.ac.in/courses/106105173)
Tool:
MATLAB, Python libraries like Scikit-fuzzy (https://scikit-fuzzy.readthedocs.io/en/latest/)
18. Data Mining
...
The Elements of Statistical Learning by Trevor Hastie, Robert Tibshirani, and Jerome Friedman (Free Online: https://hastie.su.domains/Papers/ESLII.pdf)
Course:
Data Mining Specialization by University of Illinois (Coursera) (https://www.coursera.org/specializations/data-mining)
Tool:
WEKA (https://www.cs.waikato.ac.nz/ml/weka/), RapidMiner (https://rapidminer.com/), Scikit-learn (https://scikit-learn.org/stable/)
...
Designing Data-Intensive Applications by Martin Kleppmann (Available on Amazon)
Course:
Databases by Stanford (OpenCourseWare) (https://online.stanford.edu/courses/cs145-introduction-databases)
Tool:
...
Course:
Computer Networking by Stanford (OpenCourseWare) (https://online.stanford.edu/courses/ee284-computer-networking)
Tool:
...
The TCP/IP Guide by Charles M. Kozierok (Free online: http://www.tcpipguide.com/free/t_Contents.htm)
Course:
Internet Protocols by University of Colorado (Coursera) (https://www.coursera.org/learn/internet-protocols)
Tool:
...
Course:
Compiler Design by Stanford University (edX) (https://www.edx.org/course/compilers)
Tool:
...
Resources:
Books:
Deep Learning by Ian Goodfellow (Free online: https://www.deeplearningbook.org/)
Neural Networks and Deep Learning by Michael Nielsen (Free online: http://neuralnetworksanddeeplearning.com/)
...
Course:
Heterogeneous Parallel Programming by University of Illinois (Coursera) (https://www.coursera.org/learn/heterogeneous-parallel-programming)
Tool:
...
Course:
Artificial Intelligence by Berkeley (OpenCourseWare) (https://inst.eecs.berkeley.edu/~cs188/sp22/)
Tool:
...
Reinforcement Learning: An Introduction by Sutton and Barto (Free online: http://incompleteideas.net/book/the-book-2nd.html)
...
Deep Reinforcement Learning Specialization by DeepLearning.AI (Coursera) (https://www.coursera.org/specializations/deep-reinforcement-learning)
Tool:

OpenAI Gym (https://gym.openai.com/), Stable Baselines (https://stable-baselines.readthedocs.io/en/master/)
27. Social Networks
...
Course:
Social and Economic Networks by Stanford University (Coursera) (https://www.coursera.org/learn/social-economic-networks)
Tool:
Gephi (https://gephi.org/), NetworkX (https://networkx.org/)
28. Data Science
...
Course:
Data Science Specialization by Johns Hopkins University (Coursera) (https://www.coursera.org/specializations/jhu-data-science)
Tool:
Pandas (https://pandas.pydata.org/), Matplotlib (https://matplotlib.org/), Seaborn (https://seaborn.pydata.org/)
...
Course:
Information Security by Georgia Tech (edX) (https://www.edx.org/micromasters/gtx-cybersecurity)
Tool:
Burp Suite (https://portswigger.net/burp), Metasploit (https://www.metasploit.com/)
...
Course:
Theory of Computation by MIT (OpenCourseWare) (https://ocw.mit.edu/courses/18-400-automata-computability-and-complexity-spring-2020/)
Tool:
JFLAP for automata simulations (http://www.jflap.org/)
32. Object-Oriented Programming (OOP)
...
Course:
Object-Oriented Programming in Java by Duke University (Coursera) (https://www.coursera.org/learn/object-oriented-programming)
Tool:
Eclipse (https://www.eclipse.org/), IntelliJ IDEA (https://www.jetbrains.com/idea/)
33. Big Data
...
Course:
Big Data Specialization by UC San Diego (Coursera) (https://www.coursera.org/specializations/big-data)
Tool:
Apache Hadoop (https://hadoop.apache.org/), Apache Spark (https://spark.apache.org/)
...
Course:
Parallel Computing by Rice University (Coursera) (https://www.coursera.org/learn/parallel-computing)
Tool:
OpenMP (https://www.openmp.org/), MPI (https://www.mpi-forum.org/)
35. Data Structures and Algorithms (DSA)
...
Course:
Algorithms Specialization by Princeton University (Coursera) (https://www.coursera.org/specializations/algorithms)
Tool:
LeetCode (https://leetcode.com/), GeeksforGeeks (https://www.geeksforgeeks.org/)
...
Course:
Interactive Computer Graphics by University of Tokyo (edX) (https://www.edx.org/course/interactive-computer-graphics)
Tool:
OpenGL (https://www.opengl.org/), Blender (https://www.blender.org/)
